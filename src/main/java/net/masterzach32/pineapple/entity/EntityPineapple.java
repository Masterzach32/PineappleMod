package net.masterzach32.pineapple.entity;
...
public class EntityPineapple extends Entity {
	...
	public EntityPineapple(World world) {
		super(world);
	}
	
	public EntityPineapple(World world, EntityLivingBase entity, EntityPlayer player) {
		super(world);
        ...
        this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, 1.0F * 2.0F * 1.5F, 1.0F);
	...
	public void setDamage(double energy) {
        this.damage = energy;
    }
