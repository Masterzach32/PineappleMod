...
public class HealingStaff extends PineappleStaff {

	public HealingStaff(int damage, int energy) {
		super(damage, energy);
	}
	
	public ItemStack setNBTTag(ItemStack stack) {
		super.setNBTTag(stack);
		stack.stackTagCompound.setDouble("damage", 2.0);
		return stack;
	}
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List dataList, boolean b) {
		...
		dataList.add("");
		dataList.add("§9Active: §3Heal §c1 §3Heart");
