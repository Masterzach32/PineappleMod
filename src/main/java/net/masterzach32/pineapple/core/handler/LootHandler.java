...
public class LootHandler {
	...
	public static void addBlacksmith() {
		...
		ChestGenHooks.getInfo("villageBlacksmith").addItem(new WeightedRandomChestContent(new ItemStack(PineappleItems.basic_staff), 1, 1, 15));
	...
	public static void addStronghold() {
		...
		ChestGenHooks.getInfo("strongholdCorridor").addItem(new WeightedRandomChestContent(new ItemStack(PineappleItems.basic_staff), 1, 1, 15));
		ChestGenHooks.getInfo("strongholdCorridor").addItem(new WeightedRandomChestContent(new ItemStack(PineappleItems.godly_healing_staff), 1, 1, 15));
	}
}