...
public class GodlyPineappleBlock extends Block {
    ...
    public void registerBlockIcons(IIconRegister blockIcon) {
        this.blockIcon = blockIcon.registerIcon(Pineapple.MODID + ":g_side");
        this.top = blockIcon.registerIcon(Pineapple.MODID + ":g_top");
        this.bottom = blockIcon.registerIcon(Pineapple.MODID + ":g_bottom");
    }
    ...
    public Item getItemDropped(int metadata, Random random, int fortune) {
        return PineappleItems.godly_pineapple;
    }
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random) {
    	...
    	world.spawnParticle("reddust", (double)(f1+f4), (double)f2, (double)(f3+f5), 0, 0, 0);
    	//world.spawnParticle("", maxX, maxX, maxX, maxX, maxX, maxX);
    }
}